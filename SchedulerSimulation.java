...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            int randPriority = random.nextInt(5) + 1;
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue, 
        ...
        System.out.println(Colors.BLUE + "  ➕ " + Colors.BOLD + Colors.CYAN + process.getName() + " ( Priority: " + process.getPriority()+")"+ // حطيت جملة طباعة اضافية هنا يا دكتور لكي اعمل مثل المثال 
                          Colors.RESET + Colors.BLUE + " enters the ready queue..."/* هذه ايضاً عدلتها حتى تطابق نفس المثال الذي قدمته لنا للفيتشر 1  */ + Colors.RESET + 
